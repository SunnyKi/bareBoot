...
build -p $WORKSPACE/bareBoot/bareBoot.dsc -a $PROCESSOR -b $VTARGET -t $TARGET_TOOLS -n 3 clean
exit $?
fi
...
build -p $WORKSPACE/bareBoot/bareBoot.dsc -a $PROCESSOR -b $VTARGET -t $TARGET_TOOLS -n 3 $*
