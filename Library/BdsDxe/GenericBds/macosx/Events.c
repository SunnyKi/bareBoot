...
UINT64 AllocateKernelMemory(UINTN* bufferLength, UINT64* virtualAddress)
{
...
VOID GetKernelPhysicalRange(UINT64* lowerAddress, UINT64* upperAddress)
{
...
EFI_STATUS GetMemoryMap(UINTN* memoryMapSize, EFI_MEMORY_DESCRIPTOR** memoryMap, UINTN* memoryMapKey, UINTN* descriptorSize, UINT32* descriptorVersion)
{
