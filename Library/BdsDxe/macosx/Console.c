...
static EFI_CONSOLE_CONTROL_SCREEN_MODE CurrentMode = EfiConsoleControlScreenGraphics;
...
{
    *Mode =  CurrentMode; // EfiConsoleControlScreenText/EfiConsoleControlScreenGraphics;
    if (GopUgaExists)
        *GopUgaExists = TRUE;
    if (StdInLocked)
        *StdInLocked = FALSE;
