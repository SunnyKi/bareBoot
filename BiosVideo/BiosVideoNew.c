  ...
  )
{
  ...
  UINT32                  HighestResolutionMode = 0;
  UINT16* VMP16;
#if 0
  UINT8*  VMP;
#endif
  ...
  //
#if 0
  VMP = (UINT8 *)&BiosVideoPrivate->VbeInformationBlock->VideoModePtr;
  ...
  //
  Status = BiosVideoGraphicsOutputSetMode (&BiosVideoPrivate->GraphicsOutput, PreferMode);
#if 0
