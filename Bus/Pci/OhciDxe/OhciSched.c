  ...
  )
{
  ...
  //
  Ohc->MaxSlotsEn = Ohc->HcSParams1.Data.MaxSlots;
  ...
  // mode (Run/Stop(R/S) ='1').
  //
  MaxScratchpadBufs      = ((Ohc->HcSParams2.Data.ScratchBufHi) << 5) | (Ohc->HcSParams2.Data.ScratchBufLo);
...
{
  if (SlotId == 0) {
    OhcWriteDoorBellReg (Ohc, 0, 0);
  } else {
    OhcWriteDoorBellReg (Ohc, SlotId * sizeof (UINT32), Dci);
  }
