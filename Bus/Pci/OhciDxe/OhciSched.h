/** @file
  ...
  This file contains the definition for OHCI host controller schedule routines.
...
#define OHC_INT_ONLY_TRANSFER_ASYNC           0x10
...
typedef struct _USB_ENDPOINT {
  ...
  // It's because some OHCI host controllers may assign the same physcial device
...
/**
  Ring the door bell to notify OHCI there is a transaction to be executed through URB.
...
/**
  Ring the door bell to notify OHCI there is a transaction to be executed.
