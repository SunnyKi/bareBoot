...
$(OUTPUT_DIR)/Gpt.com: $(MODULE_DIR)/Gpt.nasmb
	$(NASM_PREFIX)nasm $(NASMB_FLAGS) -i $(MODULE_DIR)/ -o $@ $?
...
$(OUTPUT_DIR)/boot1_12.com: $(MODULE_DIR)/boot1_XX.nasmb
	$(NASM_PREFIX)nasm $(NASMB_FLAGS) -i $(MODULE_DIR)/ -DFAT=12 -o $@ $?

$(OUTPUT_DIR)/boot1_16.com: $(MODULE_DIR)/boot1_XX.nasmb
	$(NASM_PREFIX)nasm $(NASMB_FLAGS) -i $(MODULE_DIR)/ -DFAT=16 -o $@ $?

$(OUTPUT_DIR)/boot1_32.com: $(MODULE_DIR)/boot1_XX.nasmb
	$(NASM_PREFIX)nasm $(NASMB_FLAGS) -i $(MODULE_DIR)/ -DFAT=32 -o $@ $?
